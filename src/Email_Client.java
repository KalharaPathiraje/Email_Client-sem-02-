...
class save {
    ...
    private static File fn = new File("ClientList.src");
        ...
        while(flag==0){
            ...
            switch(option){
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.print("How  many mails :");
                    Scanner scanner7 = new Scanner(System.in);
                    int da=scanner7.nextInt();
                    System.out.print("mail :");
                    Scanner scanner6 = new Scanner(System.in);
                    String dat=scanner6.nextLine();
                    String[] ar=dat.split(",");
                    for(int i=0;i<da;i++)
                        email.send(ar[0],ar[1],ar[2]);
                default:
                    flag=1;
                    break;
            }
